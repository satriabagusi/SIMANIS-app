...
const TambahAbsensi = () => {
  ...
  return (
    ...
    <Appbar.Header>
      ...
      <Appbar.Content title="Tambah Data Tugas Siswa" />
    </Appbar.Header>
    ...
    <View>
    <Text style={{fontFamily:'Poppins_400Regular', left:5, top:10,bottom:10, color:'black'}}>Isi Tugas</Text>
    <TextInput
        style={{backgroundColor:theme.colors.background, top:5, borderWidth:2, borderColor: theme.colors.primary}}
    ...
    <View>
    <Text style={{fontFamily:'Poppins_400Regular', left:5, top:10,bottom:10, color:'black'}}>Tanggal pengumpulan Tugas</Text>
    <DataTable.Row>
        <DataTable.Cell>
