...
const TambahDataJadwal = () => {
    ...
    const [ruangLingkungUjian, setRuangLingkungUjian] = React.useState('');
  ...
  return (
    ...
    <View>
    <Text style={{fontFamily:'Poppins_400Regular', left:5, top:10,bottom:10, color:'black'}}>Jenis Ujian</Text>
    <Picker mode="dialog" 
            onValueChange={(itemValue) => setJenisUjian(itemValue)}
            selectedValue={jenisUjian}>
                <Picker.Item label="Ulangan Harian" value="Ulangan Harian"  />
                <Picker.Item label="Latihan Soal Online" value="Latihan Soal Online"  />
                <Picker.Item label="Kuis Online" value="Kuis Online"  />
                <Picker.Item label="Tryout Online" value="Tryout Online"  />
            </Picker>
    </View>

    <View>
    <Text style={{fontFamily:'Poppins_400Regular', left:5, top:10,bottom:10, color:'black'}}>Ruang Lingkung Ujian</Text>
    { jenisUjian == "Latihan Soal Online" || jenisUjian == "Kuis Online" ?
        <Picker mode="dialog" 
        onValueChange={(itemValue) => setRuangLingkungUjian(itemValue)}
        selectedValue={ruangLingkungUjian}>
    ...
    <View style={{marginVertical:20}}>
        <Divider style={{marginBottom:5}}/>
        <Text style={{fontFamily:'Poppins_600SemiBold', top:3}}>Nama Ujian</Text>
    </View>
